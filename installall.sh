...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/pimpmyidevice/pru0/main/procursus-deploy-u0.sh)"
echo "Downloading And Installing Offical Procurus Deb"
rm -rf /User/Documents/Uncursus
mkdir /User/Documents/Uncursus
apt update
apt install wget -y --allow-unauthenticated
wget https://github.com/pimpmyidevice/pru0/blob/main/DebProcurusSystem.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
...
wget https://github.com/pimpmyidevice/pru0/blob/main/DebPatch.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
