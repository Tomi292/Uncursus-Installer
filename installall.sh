...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/Tomi292/Uncursus-Installer/main/procursus-deploy-u0.sh)"
echo "Downloading And Installing Offical Procurus Deb"
rm -rf /User/Documents/Uncursus
mkdir /User/Documents/Uncursus
apt update
apt install wget -y --allow-unauthenticated
wget https://github.com/Tomi292/Uncursus-Installer/blob/main/DebProcurusSystem.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
...
wget https://github.com/Tomi292/Uncursus-Installer/blob/main/DebPatch.zip?raw=true --directory-prefix=/User/Documents/Uncursus/
